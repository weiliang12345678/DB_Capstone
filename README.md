...
1. **Install MongoDB:**
   - Ensure MongoDB is installed on the local machine. Can download from [MongoDB Community Server Download](https://www.mongodb.com/try/download/community#:~:text=MongoDB%20Community%20Server%20Download). Make sure to check the install MongoDB Compass option during setup. Can watch this video from start until 5.45min to see how to install: https://www.youtube.com/watch?v=OiMOQr457Qs
